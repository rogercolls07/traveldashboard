...
APIs Integrades: L'aplicació es comunica amb les següents APIs públiques per obtenir dades en temps real:

Open-Meteo API: Per a les dades meteorològiques de la destinació.
Frankfurter API: Per a l'actualització de les taxes de canvi de moneda.
Google Maps (Embed): Per generar la visualització del mapa.
Disseny i UI/UX:
